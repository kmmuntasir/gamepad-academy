...
|----------|---------------|
| 1 | Verify shared engine — `gamepad-manager.js`, `utils.js`, `styles`, homepage wiring |
| 2 | Verify individual games — `games/<name>/index.html`, `game.js`, pure logic |
| 3 | Check tests, assets, and config across the project |
...
2. **Is it complete?** — Read content, check for stubbed code (`// TODO`, `pass`, `return null`)
...
|--------|-------|---------|-------|
| T2 | Title | test.ts | Tests not written |

### ❌ Missing Tasks

| Task ID | Title | Missing Files/Features |
|--------|-------|----------------------|
| T3 | Title | backend/routes/sales.ts |
